...
- **Versión 1:** Clasificación multiclase con uso de librearias, así como evaluación del modelo usando matrices de confusión.
- **Librería usada:** tensorFlow/keras/sklearn
- **Acceso:** [![Open In Colab](https://colab.research.google.com/assets/colab-badge.svg)](https://colab.research.google.com/drive/12FHxAjPL03opd8oqqDVBbOF9Fgg-6SeQ?usp=sharing)
